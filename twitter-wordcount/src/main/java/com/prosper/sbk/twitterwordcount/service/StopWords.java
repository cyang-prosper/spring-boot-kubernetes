...
public class StopWords {
	...
	public static final Set<String> stopWords = Stream.of("a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all", "almost", 
			"alone", "along", "already", "also","although","always","am","among", "amongst", "amoungst", "amount",  "an", "and", "another", "any","anyhow","anyone",
			...
			"latter", "latterly", "least", "less", "ltd", "made", "many", "may", "me", "meanwhile", "might", "mill", "mine", "more", "moreover", "most", "mostly", 
			"move", "much", "must", "my", "myself", "name", "namely", "neither", "never", "nevertheless", "next", "nine", "no", "nobody", "none", "noone", "nor", 
			"not", "nothing", "now", "nowhere", "of", "off", "often", "on", "once", "one", "only", "onto", "or", "other", "others", "otherwise", "our", "ours", 
			"ourselves", "out", "over", "own","part", "per", "perhaps", "please", "put", "rather", "re", "same", "see", "seem", "seemed", "seeming", "seems", 
			...
			"would", "yet", "you", "your", "yours", "yourself", "yourselves", "the", "like", "it's", "just", "people", "i'm", "im", "can't", "that's", "don't", "new",
			"really", "doing", "going", "new", "time", "got", "want", "did", "guy", "guys", "day", "follow", "retweet", "love", "good", "today", "free", "night")
